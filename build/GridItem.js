...
var GridItem = /*#__PURE__*/function (_React$Component) {
  ...
  _createClass(GridItem, [{
    ...
    /*: ReactElement<any>*/
    {
      ...
      return /*#__PURE__*/_react.default.createElement(_reactResizable.Resizable, _extends({
        draggableOpts: {
    ...
    /*: ReactNode*/
    {
      var _this$props9 = this.props,
          ...
          _this$props9$resizabl = _this$props9.resizableProps,
          resizableProps = _this$props9$resizabl === void 0 ? {} : _this$props9$resizabl;
      ...
      newChild = this.mixinResizable(newChild, pos, isResizable, resizableProps); // Draggable support. This is always on, except for with placeholders.
...
_defineProperty(GridItem, "propTypes", {
  ...
  // Resizable props
  resizableProps: _propTypes.default.object,
  // Others
